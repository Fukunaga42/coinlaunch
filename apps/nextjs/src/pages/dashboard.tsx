...
const TokenBalanceItem: React.FC<{ 
  ...
  const handleAddressClick = (e: React.MouseEvent) => {
    e.stopPropagation();
    window.open(`https://eth-sepolia.blockscout.com/address/${tokenAddress}`, '_blank');
  };
...
const UserDashboard: React.FC = () => {
  ...
  return (
    <Layout>
      <SEO 
        title="Your Token Dashboard - Coinlaunch"
        description="Manage your tokens and track your transactions in one place. Your personal Coinlaunch dashboard."
        image="seo/dash.jpg"
      />
